...
<title>Online Restaurant Table Booking System</title>
<meta charset="utf-8">
...
<nav class="navbar navbar-expand-md navbar-light fixed-top">
		...
		<strong><em>Online Restaurant Table Booking System</em></strong>
            </a>
    ...
    <!---sign up form -->
                    <div class="signup-form">
                        <form action="includes/signup.inc.php" method="post">
                            ...
                            <div class="text-center">Already have an account? <a href="#/login.ic">Sign in</a></div>
                    </div> 	
                </div>        
